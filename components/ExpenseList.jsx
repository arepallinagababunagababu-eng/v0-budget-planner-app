...
export default function ExpenseList({ refresh }) {
  ...
  if (expenses.length === 0) {
    return <div className="text-center py-8 text-gray-600">No expense records yet</div>
  }
        ...
        <tbody className="divide-y">
          {expenses.map((item) => (
            <tr key={item._id} className="hover:bg-gray-50">
              ...
              <td className="px-6 py-4 text-sm font-semibold text-red-600">${item.amount.toFixed(2)}</td>
